...
?>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery2.1.3/jquery.min.js"></script>
            ...
            <div style="padding-top:30px" class="panel-body">
              <?php
                ...
                <form id="loginform" class="form-horizontal" role="form" method="POST" action="">
                    ...
                    <p>
                        <h3>Admin Login</h3>
                        <strong>Email:</strong>anu@code.com<br>
                        <strong>Password:</strong>123
                    </p>
                    <p>
                        <h3>HR login:</h3>
                        <strong>Email:</strong>hr@code.com<br>
                        <strong>Password:</strong>123
                    </p>
                </form>    
...
?>
    ...
    <!-- <div class="container">
        <form id="loginform" class="form-horizontal" role="form" method="POST" action="">
            <div style="margin-bottom: 25px" class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                <input type="text" class="form-control" id="email" name="email" value="<?php if(!empty($_POST["
                    email"])) { echo $_POST["email"]; } ?>" placeholder="email" style="background:white;" required>
            </div>
            <div style="margin-bottom: 25px" class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                <input type="password" class="form-control" id="password" name="password"
                    value="<?php if(!empty($_POST[" password"])) { echo $_POST["password"]; } ?>" placeholder="password"
                required>
            </div>
            <div style="margin-top:10px" class="form-group">
                <div class="col-sm-12 controls">
